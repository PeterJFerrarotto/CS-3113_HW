...
public:
	CollisionListener(unsigned entityType1, unsigned entityType2, COLLISION_BEHAVIOR behaviorOfEntity1 = COLLISION_BEHAVIOR_SIZE, COLLISION_BEHAVIOR behaviorOfEntity2 = COLLISION_BEHAVIOR_SIZE, bool entity2Down = true, bool entity2Up = true, bool entity2Left = true, bool entity2Right = true);
	~CollisionListener();

...
TextEntity::TextEntity(const std::string& text, GLuint textSheet, float size, float spacing, float startingX, float startingY) : textSheet(textSheet), size(size), spacing(spacing), startingX(startingX), startingY(startingY)
{
	this->text = text;
	position.x = startingX;
	position.z = startingY;

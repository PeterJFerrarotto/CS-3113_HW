...
enum TEXTURE_TYPE { IMAGE, EVEN_SPRITESHEET, UNEVEN_SPRITESHEET, TEXT, TEXTURE_TYPE_COUNT };
...
public:
	...
	Texture(GLuint textureID, rapidxml::xml_document<>* xmlDoc, const std::string& spriteName, float size, unsigned textureLayer, float sheetWidth = 1024.0f, float sheetHeight = 1024.0f);
	//Done
